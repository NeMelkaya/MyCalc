...
class AchievementView : RelativeLayout {
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        try {
            ...
            attributes.leftPartWidth = typedArray.getDimensionPixelSize(R.styleable.AchievementView_leftPartWidth,
                    AchievementViewAttributes.DEFAULT_LEFT_PART_WIDTH.toInt()).toFloat()
